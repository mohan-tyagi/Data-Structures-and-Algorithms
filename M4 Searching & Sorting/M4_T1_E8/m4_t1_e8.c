...
int val, lft=1,rt=MX,md=(lft+rt)/2 ;    /* declaration of array and variables. Here lft will be used for storing the left most subscript and rt for right most subscript. md variable stores middle subscript */
